...
namespace AdvancedGameList.Controllers
{
    public class DeveloperController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Location,IsAAA")] Developer developer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Location,IsAAA")] Developer developer)
        {
            if (ModelState.IsValid)
            {
